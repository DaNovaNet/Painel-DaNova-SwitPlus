...
exit;
  ...
  echo -e 'by: @DANOVANET' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "WEB DANOVA SWIT SSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @DANOVANET\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/DaNovaNet/Painel-DaNova-SwitPlus/raw/main/install/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@DANOVANET\033[0m" | lolcat
echo ""
